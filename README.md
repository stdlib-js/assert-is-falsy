...
```javascript
import isFalsy from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-falsy@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-falsy/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/assert-is-falsy/actions/workflows/test.yml?query=branch:v0.1.1
