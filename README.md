...
-   [`@stdlib/assert/is-falsy-array`][@stdlib/assert/is-falsy-array]: test if a value is an array-like object containing only falsy values.
-   [`@stdlib/assert/is-truthy`][@stdlib/assert/is-truthy]: test if a value is truthy.
...
[test-image]: https://github.com/stdlib-js/assert-is-falsy/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-is-falsy/actions/workflows/test.yml
